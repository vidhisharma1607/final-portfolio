          ...
          <Box className="ProjDesc" sx={{ flexGrow: 1, marginTop: "40px" }}>
            ...
            <Box sx={{ flexGrow: 1, width: { xs: "90%", sm: "80%" } }}>
              <Typography
                ...
                sx={{ color: "#000000" }}
              >
                The goal of this UX case study was to create an app that could
                bridge the communication gap between children and
                educators/parents when it comes to sex education. The project
                aimed to address the importance of sex education for children
                and the challenges that educators and parents face when it comes
