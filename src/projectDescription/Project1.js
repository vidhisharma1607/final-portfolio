...
const Project1 = () => {
    ...
    <div id='top' className="grid" style={{  width: '100%', height: "100%", backgroundColor: 'white', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', position: 'sticky', top: 0, zIndex:1000, flexDirection: "column", paddingTop:"35%", alignItems: "center", height: "100vh" }}>
        <Avatar width="62.75px" height="49.6px" sx={{ bgcolor: "black",  }} variant="square">
         <a href="/"> <video width="62.75px" height="49.6px" autoPlay loop muted src={logoRaghav} /></a>
        </Avatar>
      </div>
      </div>
      ...
      {/* Second column */}
      <div style={{ width: '100%' }}>
        <Box sx={{ flexGrow: 1, width: "100%", margin: "auto", display: 'block', '@media screen and (max-width: 768px)': { width: "100%", margin:"auto" } }}>
        ...
        <Box className="ProjDesc" sx={{ flexGrow: 1,  marginTop: "40px" }} >
          <Typography fontFamily={"Poppins"} fontWeight={700} fontSize={{ xs: "10px", sm: "30px" }} sx={{ color: "#0101F3" }}>Vetic - Pet Care Reimagined</Typography>
          <Typography fontFamily={"Poppins"} fontSize={{ xs: "10px", sm: "14px" }} lineHeight={3} sx={{ color: "#0101F3" }}><i>UX UI | Branding | Website Design</i></Typography>
          <Box sx={{ flexGrow: 1, width: { xs: "90%", sm: "60%" } }}>
            <Typography  variant='body' fontFamily={"Poppins"} fontSize={{ xs: "8px", sm: "12px"}} lineHeight={1} sx={{ color: "#000000" }}>This project is focused on providing high-quality veterinary care for pets, with a commitment to affordability and convenience. It features a digital-first approach that combines modern clinics with innovative technology to create a comfortable and stress-free experience for both pets and their owners.</Typography>
          </Box>
        </Box>
        <Box sx={{ display: "flex", marginTop:"20px", flexDirection: "column", width: "100%", height: "auto", '@media screen and (max-width: 450px)': { width: "100%" } }}>
          
            <img alt="image"style={{ width: "100%", maxWidth: "905px", height: "auto" }} src={img1} />
         
         
            <img alt="image1" style={{ width: "100%", maxWidth: "905px", height: "auto" }} src={img2} />
          
          
            <img alt="image1" style={{ width: "100%", maxWidth: "905px", height: "auto" }} src={img3} />
            ...
            <img id ="mockup" alt="image1" style={{ width: "100%", maxWidth: "905px", height:"100%"}} src={img11} />
  ...
  alignItems="center" sx={{ background:"black"}} >
    <Typography  marginTop="10%" fontFamily={"Krona One"} fontWeight={100}  color="white"  fontSize={"21px"}>Thanks for watching
          ...
          <Typography fontWeight={200} marginTop="1%" fontFamily={"Work Sans"} fontWeight={100}  color="white" fontSize={"20.5px"} > 💖
          </Typography>
         
        <Typography  marginTop="1%" marginBottom="2%" fontFamily={"Krona One"}  fontWeight={100} color="white" width={"40%"} textAlign={"center"} fontSize={"10.5px"}>Calling all feedback ninjas! I need your stealthy insights to level up!
