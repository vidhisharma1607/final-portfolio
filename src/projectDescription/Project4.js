    ...
    <div id='top' className="grid" style={{  width: '100%', height: "100%", backgroundColor: 'white', gap: '20px' }}>
      ...
      <div style={{ width: '100%' }}>
        ...
        <Box className="ProjDesc" sx={{ flexGrow: 1,  marginTop: "40px" }} >
          <Typography fontFamily={"Poppins"} fontSize={{ xs: "10px", sm: "30px" }} fontWeight={700} sx={{ color: "#0101F3" }}>Looks Salon</Typography>
          <Typography fontFamily={"Poppins"} fontSize={{ xs: "10px", sm: "14px" }} lineHeight={3} sx={{ color: "#0101F3" }}><i>Social Media | Visual Design </i></Typography>
          <Box sx={{ flexGrow: 1, width: { xs: "90%", sm: "60%" } }}>
            <Typography variant='body' fontFamily={"Poppins"} fontSize={{ xs: "8px", sm: "12px" }} lineHeight={-1} sx={{ color: "#000000" }}>The Looks Salon project is dedicated to delivering exceptional beauty services and styling expertise, embracing a contemporary salon concept with cutting-edge digital integration. As a Visual Designer, I enriched the brand's appeal through captivating social media content and compelling graphic design elements.</Typography>
          </Box>
        </Box>
      ...
      <div style={{ display: 'flex', position: 'sticky', top: 0, zIndex: 1000, flexDirection: "column", justifyContent: "center", alignItems: "center", height: "100vh" }}>
       <Typography fontFamily={"Krona One"} fontSize={{ xs: "10px", sm: "12px" }}><a href="#top"  onMouseEnter={(e) => e.target.style.color = '#AAE800'} onMouseLeave={(e) => e.target.style.color = 'black'}  style={{color:"black" , textDecoration:"none"}}>Top of Page</a></Typography>
